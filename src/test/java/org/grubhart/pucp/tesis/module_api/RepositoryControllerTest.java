...
class RepositoryControllerTest {
    ...
    void updateRepository_whenRepositoryExists_shouldUpdateAndReturn() {
        // Given
        Long repoId = 1L;
        UpdateRepositoryRequest request = new UpdateRepositoryRequest("new-service-name", null, null);
    ...
    void updateRepository_whenSettingNull_shouldAllowIt() {
        // Given
        Long repoId = 1L;
        UpdateRepositoryRequest request = new UpdateRepositoryRequest(null, null, null);
    ...
    void updateRepository_whenRepositoryNotFound_shouldReturn404() {
        // Given
        Long repoId = 999L;
        UpdateRepositoryRequest request = new UpdateRepositoryRequest("service-name", null, null);
    ...
    void updateRepository_whenSaveThrowsException_shouldReturnInternalServerError() {
        // Given
        Long repoId = 1L;
        UpdateRepositoryRequest request = new UpdateRepositoryRequest("new-service", null, null);
